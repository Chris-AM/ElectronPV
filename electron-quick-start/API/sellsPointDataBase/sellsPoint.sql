...
ALTER TABLE boleta
MODIFY COLUMN venta_total INT NOT NULL;
ALTER TABLE boleta
MODIFY COLUMN fecha_hora_venta TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE cierre
MODIFY COLUMN dia_cierre TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE venta
MODIFY COLUMN fecha_hora_venta TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE venta
MODIFY COLUMN venta_total INT NOT NULL;